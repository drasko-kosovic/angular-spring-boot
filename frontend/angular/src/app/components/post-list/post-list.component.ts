...
export class PostListComponent implements OnInit {
  ...
  constructor(private ngxNotificationService: NgxNotificationService,private postService: PostService, private route: ActivatedRoute) {
  }
  ...
  getPosts(): void {
    this.postService.list()
      .subscribe(
        data => {
          this.posts = data;
            this.ngxNotificationService.sendMessage('Uspjesno su ucitani podaci', 'success', 'bottom-right');
        },
        error => {
          console.error(error);
